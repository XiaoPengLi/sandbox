...
public class SecurityTokenServiceProvider implements Provider<Source> {
	...
	private final String WSTRUST_REQUESTTYPE_ISSUE = WSTRUST_13_NAMESPACE
			+ "/Issue";
	private final String WSTRUST_REQUESTTYPE_CANCEL = WSTRUST_13_NAMESPACE
			+ "/Cancel";
	private final String WSTRUST_REQUESTTYPE_RENEW = WSTRUST_13_NAMESPACE
			+ "/Renew";
	private final String WSTRUST_REQUESTTYPE_VALIDATE = WSTRUST_13_NAMESPACE
			+ "/Validate";
	private final String WSTRUST_REQUESTTYPE_REQUESTCOLLECTION = WSTRUST_13_NAMESPACE
			+ "/RequestCollection";
	private final String WSTRUST_REQUESTTYPE_KEYEXCHANGETOKEN = WSTRUST_13_NAMESPACE
			+ "/KeyExchangeToken";
	...
	private RequestSecurityTokenType convertToJAXBObject(Source source)
			throws Exception {
